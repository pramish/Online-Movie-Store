...
public class ResetDB {
    ...
    private static void addData(Statement st) throws SQLException{
        ...
        // USER DATA
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456789', 'HaydenBainton@jourrapide.com', 'Hayden', 'aiTah9vuGu', '(08) 8294 1740', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456790', 'HenryDodgshun@superrito.com', 'Henry', 'rei0She6hi', '(08) 9063 8276', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456791', 'PatrickLetcher@teleworm.us', 'Patrick', 'Eef7aeYah4', '(03) 8865 6511', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456792', 'SpencerVirgo@teleworm.us', 'Spencer', 'mahH0poph', '(02) 6110 3269', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456793', 'SofiaBlundell@superrito.com', 'Sofia', 'Ooteedie6h', '(07) 4988 7100', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456794', 'LilianShapcott@armyspy.com', 'Lilian', 'Ood0aesivi', '(03) 6259 7177', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456795', 'AaronBrifman@rhyta.com', 'Aaron', 'Phaehoh1t', '(08) 8777 2381', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456796', 'ZacharyElkington@dayrep.com', 'Zachary', 'oB1en8Ch', '(07) 3329 3524', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456797', 'AaronTrouette@einrot.com', 'Aaron', 'mah5Phohha', '(02) 6135 6661', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456798', 'OwenMacdonald@jourrapide.com', 'Owen', 'iePh4Quah6', '(08) 9313 2088', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456799', 'SiennaMcKeown@gustr.com', 'Sienna', 'UbeeNgi7b', '(03) 5348 8738', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456800', 'EllaWeindorfer@gustr.com', 'Ella', 'Yae5ait9ot', '(03) 9450 1815', 'CANCELLED')";
        ...
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456802', 'MiaBurges@cuvox.de', 'Mia', 'oocai2Ot', '(08) 8706 8402', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456803', 'NoahODonovan@armyspy.com', 'Noah', 'Sichaiw2hoo', '(07) 4099 4645', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456804', 'StephanieFereday@einrot.com', 'Stephanie', 'IP8thath', '(03) 5362 2712', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456805', 'DylanSmeaton@einrot.com', 'Dylan', 'ieMoov8oo', '(02) 6128 3045', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456806', 'GabrielForlong@einrot.com', 'Gabriel', 'Aeh0eeghoo', '(02) 6187 5620', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456807', 'PoppySuttor@gustr.com', 'Poppy', 'eej1Eb2sie', '(03) 5383 1919', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456808', 'FinnBroome@gustr.com', 'Finn', 'lohp8Iewi', '(02) 6197 5870', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456809', 'GabrielAlgeranoff@fleckens.hu', 'Gabriel', 'bai2en2aH', '(02) 6720 2273', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456810', 'RebeccaFreame@einrot.com', 'Rebecca', 'eePeo5ee', '(07) 4983 3842', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456811', 'OliviaBodenwieser@einrot.com', 'Olivia', 'koov1yaiThoh', '(03) 5308 1256', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456812', 'JamieToRot@gustr.com', 'Jamie', 'juv5ahhooSh', '(02) 4900 6411', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456813', 'LolaHeagney@rhyta.com', 'Lola', 'ooca7puJ0aing', '(02) 9656 2195', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456814', 'LeahBury@superrito.com', 'Leah', 'euh5wai5Dah', '(08) 8250 5485', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456815', 'TaylahTench@fleckens.hu', 'Taylah', 'Ohy4aeNgoh', '(02) 4087 5051', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456816', 'GraceLillico@gustr.com', 'Grace', 'ahjiZahl7th', '(03) 5381 4041', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456817', 'BenEdmondstone@armyspy.com', 'Ben', 'Ove4moh8ai', '(02) 9071 0770', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456818', 'KatieGarratt@jourrapide.com', 'Katie', 'ood6IShoe', '(03) 5317 1485', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456819', 'KatieHoulding@gustr.com', 'Katie', 'Cheifie6u', '(08) 8351 9475', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456820', 'JordanMcClelland@fleckens.hu', 'Jordan', 'Eekoh2ua', '(03) 5370 8582', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456821', 'LucySharman@fleckens.hu', 'Lucy', 'aiqu2Equ', '(02) 6743 0974', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456822', 'JettColdham@superrito.com', 'Jett', 'JoaSh4aex', '(02) 6125 0280', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456823', 'BethanySwanston@teleworm.us', 'Bethany', 'tha9eeK8', '(02) 4910 9600', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456824', 'CalebBertie@fleckens.hu', 'Caleb', 'ohnauNg7', '(08) 9432 7422', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456825', 'JamieCook@rhyta.com', 'Jamie', 'iepho7giX0Shee', '(02) 4252 0343', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456826', 'ClaireVarley@teleworm.us', 'Claire', 'Tohd0hu7Oh', '(08) 9386 7941', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456827', 'LukeAvery@teleworm.us', 'Luke', 'Iiceiqu5', '(07) 3530 7293', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456828', 'TristanColdham@dayrep.com', 'Tristan', 'naiKaez3ai', '(02) 4982 8480', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456829', 'TajRose@gustr.com', 'Taj', 'thohRieH5oe', '(07) 4519 8510', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456830', 'AmySwayne@fleckens.hu', 'Amy', 'uBahje0oo', '(02) 4960 8672', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456831', 'SophiaBoothman@dayrep.com', 'Sophia', 'adi8ieXah', '(08) 9271 7352', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456832', 'GeorgeFlanagan@fleckens.hu', 'George', 'ohR9chaach5', '(08) 9097 1171', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456833', 'AbbyKiek@cuvox.de', 'Abby', 'Ahz8ohnaeG', '(02) 6798 2777', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456834', 'AnnabelleLucas@armyspy.com', 'Annabelle', 'eiZo7cup', '(08) 8396 8937', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456835', 'IsaacFitchett@dayrep.com', 'Isaac', 'uree1thooH', '(08) 8387 4380', 'DEACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456836', 'AbbyTate@fleckens.hu', 'Abby', 'Gokahr6alae', '(07) 3786 0444', 'CANCELLED')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456837', 'NoahRiley@gustr.com', 'Noah', 'Ez5oo6wae3m', '(03) 5366 1405', 'ACTIVE')";
        query[count++] = "INSERT INTO \"USER\" (ID, EMAIL, \"NAME\", PASSWORD, PHONENUMBER, STATUS) VALUES ('123456838', 'admin@oms.com', 'Admin', 'password', '(02) 4068 1547', 'ACTIVE')";
...
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456791', 'Patrick', 'PatrickLetcher@teleworm.us', 'INDIVIDUAL', '12 Amiens Road ILFORD, New South Wales, 2850', 'CANCELLED')";
...
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456794', 'Lilian', 'LilianShapcott@armyspy.com', 'COMPANY', '35 Dalgarno Street PILLIGA, New South Wales, 2388', 'CANCELLED')";
...
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456797', 'Aaron', 'AaronTrouette@einrot.com', 'INDIVIDUAL', '30 Carba Road EIGHT MILE CREEK, South Australia, 5291', 'CANCELLED')";
...
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456800', 'Ella', 'EllaWeindorfer@gustr.com', 'COMPANY', '40 Flax Court CORAL BANK, Victoria, 3691', 'CANCELLED')";
...
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456803', 'Noah', 'NoahODonovan@armyspy.com', 'INDIVIDUAL', '50 Dossiter Street LEMONT, Tasmania, 7120', 'CANCELLED')";
...
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456806', 'Gabriel', 'GabrielForlong@einrot.com', 'COMPANY', '69 Henry Moss Court HORNSDALE, South Australia, 5491', 'CANCELLED')";
...
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456809', 'Gabriel', 'GabrielAlgeranoff@fleckens.hu', 'INDIVIDUAL', '71 Murphy Street MURESK, Western Australia, 6401', 'CANCELLED')";
...
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456812', 'Jamie', 'JamieToRot@gustr.com', 'COMPANY', '52 Wynyard Street MIDWAY, New South Wales, 2720', 'CANCELLED')";
...
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456815', 'Taylah', 'TaylahTench@fleckens.hu', 'INDIVIDUAL', '21 Millicent Drive UPPER CHICHESTER, New South Wales, 2420', 'CANCELLED')";
...
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456818', 'Katie', 'KatieGarratt@jourrapide.com', 'COMPANY', '65 Hill Street MIDDLETON, Tasmania, 7163', 'CANCELLED')";
query[count++] = "INSERT INTO CUSTOMER (ID, \"NAME\", EMAIL, \"TYPE\" ,ADDRESS, STATUS) VALUES ('223456819', 'Admin', 'admin@oms.com', 'INDIVIDUAL', '65 Correa Place NIGHTCLIFF, Northern Territory, 810', 'ACTIVE')";
        ...
        // MOVIE DATA
        query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456789', 'Escape Room', 'Horror', 20, 0, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456790', 'Call of the Wild', 'Documentary', 15, 73, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456791', 'The Age of Adaline', 'Romance', 20, 99, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456792', 'Robin Hood', 'Adventure', 20, 0, 'DEACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456793', 'Megamind', 'Science Fiction', 10, 38, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456794', 'That Awkward Moment', 'Comedy', 5, 0, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456795', 'Happy Death Day 2U', 'Horror', 20, 67, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456796', 'Aliens of the Deep', 'Documentary', 20, 41, 'DEACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456797', 'City of Angels', 'Romance', 30, 33, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456798', 'Gulliver's Travels', 'Adventure', 20, 29, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456799', 'Dark Phoenix', 'Science Fiction', 10, 18, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456800', 'Deadpool 2', 'Comedy', 10, 0, 'DEACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456801', 'Pet Sematary', 'Horror', 10, 17, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456802', 'Hearts and Minds', 'Documentary', 10, 17, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456803', 'The Fault in Our Stars', 'Romance', 5, 21, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456804', 'The Last Airbender', 'Adventure', 20, 63, 'DEACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456805', 'Brightburn', 'Science Fiction', 15, 45, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456806', 'Gringo', 'Comedy', 20, 0, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456807', 'Us', 'Horror', 20, 89, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456808', 'Man from Plains', 'Documentary', 10, 122, 'DEACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456809', 'Lovestruck', 'Romance', 5, 9, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456810', 'Immortals', 'Adventure', 20, 16, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456811', 'Terminator: Dark Fate', 'Science Fiction', 20, 2, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456812', 'The Boss Baby', 'Comedy', 30, 0, 'DEACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456813', 'Velvet Buzzsaw', 'Horror', 20, 8, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456814', 'Predictions of Fire', 'Documentary', 10, 20, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456815', 'Something Borrowed', 'Romance', 10, 33, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456816', 'Wrath of the Titans', 'Adventure', 10, 0, 'DEACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456817', 'The Three-Body Problem', 'Science Fiction', 10, 10, 'ACTIVE')";
query[count++] = "INSERT INTO MOVIE (ID, TITLE, GENRE, PRICE, STOCK, STATUS) VALUES ('323456818', 'Zootopia', 'Comedy', 5, 4, 'ACTIVE')";
...
query[count++] = "INSERT INTO USERACCESSLOG (ID, USERID, ACCESSTYPE, \"TIMESTAMP\") VALUES ('523456988', '123456838', 'LOGOUT', '2019-03-07 04:31:11.000')";
        ...
        // ORDER DATA
        query[count++] = "INSERT INTO \"ORDER\" (ID, CUSTOMERID, MOVIEID, USERID, PRICE, AMOUNT, TOTALPRICE, \"DATE\", STATUS) VALUES ('623456789', '223456819', '323456789', '123456838', 20, 1, 20, '2019-05-24', ' COMPLETED')";
...
query[count++] = "INSERT INTO \"ORDER\" (ID, CUSTOMERID, MOVIEID, USERID, PRICE, AMOUNT, TOTALPRICE, \"DATE\", STATUS) VALUES ('623456792', '223456819', '323456792', '123456838', 20, 1, 20, '2019-05-18', ' COMPLETED')";
...
query[count++] = "INSERT INTO \"ORDER\" (ID, CUSTOMERID, MOVIEID, USERID, PRICE, AMOUNT, TOTALPRICE, \"DATE\", STATUS) VALUES ('623456795', '223456819', '323456795', '123456838', 20, 1, 20, '2019-05-12', ' COMPLETED')";
...
query[count++] = "INSERT INTO \"ORDER\" (ID, CUSTOMERID, MOVIEID, USERID, PRICE, AMOUNT, TOTALPRICE, \"DATE\", STATUS) VALUES ('623456798', '223456790', '323456798', '123456790', 20, 3, 60, '2019-05-06', ' COMPLETED')";
...
query[count++] = "INSERT INTO \"ORDER\" (ID, CUSTOMERID, MOVIEID, USERID, PRICE, AMOUNT, TOTALPRICE, \"DATE\", STATUS) VALUES ('623456801', '223456793', '323456801', '123456793', 10, 2, 20, '2019-04-30', ' COMPLETED')";
...
query[count++] = "INSERT INTO \"ORDER\" (ID, CUSTOMERID, MOVIEID, USERID, PRICE, AMOUNT, TOTALPRICE, \"DATE\", STATUS) VALUES ('623456804', '223456796', '323456804', '123456796', 20, 1, 20, '2019-04-24', ' COMPLETED')";
...
query[count++] = "INSERT INTO \"ORDER\" (ID, CUSTOMERID, MOVIEID, USERID, PRICE, AMOUNT, TOTALPRICE, \"DATE\", STATUS) VALUES ('623456807', '223456799', '323456807', '123456799', 20, 1, 20, '2019-04-18', ' COMPLETED')";
...
query[count++] = "INSERT INTO \"ORDER\" (ID, CUSTOMERID, MOVIEID, USERID, PRICE, AMOUNT, TOTALPRICE, \"DATE\", STATUS) VALUES ('623456810', '223456802', '323456810', '123456802', 20, 1, 20, '2019-04-12', ' COMPLETED')";
...
query[count++] = "INSERT INTO \"ORDER\" (ID, CUSTOMERID, MOVIEID, USERID, PRICE, AMOUNT, TOTALPRICE, \"DATE\", STATUS) VALUES ('623456813', '223456805', '323456813', '123456805', 20, 2, 40, '2019-04-06', ' COMPLETED')";
...
query[count++] = "INSERT INTO \"ORDER\" (ID, CUSTOMERID, MOVIEID, USERID, PRICE, AMOUNT, TOTALPRICE, \"DATE\", STATUS) VALUES ('623456816', '223456808', '323456816', '123456808', 10, 1, 10, '2019-03-31', ' COMPLETED')";
